...
; Function:    Multiply
; Processor:   C55xx
; Description: Implements a vector multiply using a single-MAC 
;              approach.
;
; Usage: ushort oflag = multiply (DATA *x,
;                             DATA *y,
;                             DATA *r,
;                             ushort nx)
;
; Copyright Texas instruments Inc, 2000
; modified from Texas Instruments' add.asm by Emma Azelborn
;****************************************************************
...
; ---------------------------------------------------------------
	...
	MPY	*AR0+, *AR1+, AC0		;vector multiply of two inputs
