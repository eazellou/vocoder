...
/* Configure AIC3204 */
    ...
    AIC3204_rset( 11, 0x82 );  // Power up NDAC and set NDAC value to 4 CHANGE THIS VALUE TO CHANGE SAMPLING RATE
    AIC3204_rset( 12, 0x87 );  // Power up MDAC and set MDAC value to 7
    AIC3204_rset( 18, 0x87 );  // Power up NADC and set NADC value to 7
    AIC3204_rset( 19, 0x84 );  // Power up MADC and set MADC value to 4 CHANGE THIS VALUE TO CHANGE SAMPLING RATE
