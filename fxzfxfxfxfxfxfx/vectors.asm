...
;**********************************************************************************
	...
	.def	_Reset;    This stops the rtsx version from being loaded !!!!!!

;****************************************************************************
;* Other interrupt vector definitions go here
;****************************************************************************
	.def	_Reset
_Reset:		.ivec    reset_isr, USE_RETA; Reset / Software Interrupt #0
...
reset_isr:
	...
	;	*port(#0x1C01) = #0x0				; Clear idles
		...
		bit (ST1, #5) = #0 ; KM 18Feb2015
    	@IVPD_L = #(_Reset >> 8) || mmap()
    	@IVPH_L = #(_Reset >> 8) || mmap()
		...
		*port(#0x0001) = 0x020E;  enable the MPORT and disable HWA .. KM
		idle
